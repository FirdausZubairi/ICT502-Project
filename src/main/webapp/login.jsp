...
<body style="display: flex; flex-direction: column; min-height: 100vh;">
	...
	<section class=" main-section" style="padding-top: 70px">
		<div class="container-fluid h-custom">
					...
					<form method="post" action="loginController">
						...
						<div class="form-outline mb-4">
							<label class="form-label" for="form3Example3">Username</label> <input
								type="username" id="form3Example3" name="username"
						...
						<div class="form-outline mb-3">
							<label class="form-label" for="role"><b>Role</b></label> <select
						...
						<div class="text-center text-lg-start mt-4 pt-2">
							...
							<p class="small fw-bold mt-2 pt-1 mb-0">
								Don't have an account? <a href="customer/register.jsp"
			...
			<footer class="fixed-bottom">
				<div
					class=" text-center text-white py-2 px-4 px-xl-5 bg-primary"
