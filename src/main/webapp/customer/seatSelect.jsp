...
<body style="display: flex; flex-direction: column; min-height: 100vh;">
	...
	<nav class="navbar fixed-top navbar-light bg-light">
		<div class="container-fluid d-flex justify-content-between">
			...
			</a> <span class="navbar-text"> Seats </span>
			...
			<form action="seatSelect" method="post">
				<div class="row">
										...
										<li>
											<ol class="seats" name="seat">
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 1A" id="1A" data-price="30" /> <label
													for="1A">1A</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 1B" id="1B" data-price="30" /> <label
													for="1B">1B</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 1C" id="1C" data-price="30" /> <label
													for="1C">1C</label></li>
											</ol>
										</li>
										<li>
											<ol class="seats">
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 2A" id="2A" data-price="30" /> <label
													for="2A">2A</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 2B" id="2B" data-price="30" /> <label
													for="2B">2B</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 2C" id="2C" data-price="30" /> <label
													for="2C">2C</label></li>
											</ol>
										</li>
										<li>
											<ol class="seats">
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 3A" id="3A" data-price="30" /> <label
													for="3A">3A</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 3B" id="3B" data-price="30" /> <label
													for="3B">3B</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 3C" id="3C" data-price="30" /> <label
													for="3C">3C</label></li>
											</ol>
										</li>
										<li>
											<ol class="seats">
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 4A" id="4A" data-price="30" /> <label
													for="4A">4A</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 4B" id="4B" data-price="30.00" /> <label
													for="4B">4B</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 4C" id="4C" data-price="30" /> <label
													for="4C">4C</label></li>
											</ol>
										</li>
										<li>
											<ol class="seats">
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 5A" id="5A" data-price="30" /> <label
													for="5A">5A</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 5B" id="5B" data-price="30" /> <label
													for="5B">5B</label></li>
												<li class="seat"><input type="checkbox" name="seat"
													value="Seat 5C" id="5C" data-price="30" /> <label
													for="5C">5C</label></li>
											</ol>
										</li>
									</ol>
					...
					<div class="col-md-5">
						...
						<div class="mt-3">
							<a href="create-ticket.jsp" class="btn btn-outline-success"
								role="button" aria-pressed="true">Back</a> 
								<button type="submit" class="btn btn-success" role="button" aria-pressed="true">Submit</button>
						</div>
					</div>
				</div>
			</form>
									...
									if (this.checked) {
										...
										cancelBtn
												.addEventListener(
														...
														function() {
															document
																	.getElementById(seats[i].id).checked = false;
															document
																	.getElementById(
																			'li'
																					+ seats[i].id)
										...
										document.getElementById('li' + this.id)
												.remove();
										totalPrice -= seatPrice;
									}
									totalDisplay.textContent = 'RM '
